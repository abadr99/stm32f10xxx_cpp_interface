...
/**
 * @brief Enumeration for system clock configuration options.
 */
enum ClkConfig {
...
/**
 * @brief Enumeration for PLL multiplier factors.
 */
enum PLL_MulFactor {
...
/**
 * @brief Enumeration for MCO (Microcontroller Clock Output) modes.
 */
enum McoModes {
